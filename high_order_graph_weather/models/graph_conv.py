"""Forecaster based on Graph Weather, use convolution layer instead of attention layer"""
from typing import Optional

import torch
from huggingface_hub import PyTorchModelHubMixin

from .layers import Decoder, Encoder, Processor


class GraphConvolutionForecaster(torch.nn.Module, PyTorchModelHubMixin):
